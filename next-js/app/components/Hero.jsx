...
const Hero = () => {
  return (
    <section className="border-20 max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
      ...
      <div className="relative flex flex-1 items-start boeder-2 ">
        <div className=" relative z-20 w-[268px] flex-col gap-8 rounded-3x1 bg-green-90 px-7 py-8">
